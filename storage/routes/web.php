...
Route::get('/print/ST/{id}', function ($id) {
    ...
    $path = storage_path('temp\st_.docx');
    $template->saveAs($path);;
    //return response()->download(storage_path('surat.docx'));
    return response()->download(storage_path('temp\st_.docx'));
});
...
Route::get('/print/undangan/{id}', function ($id) {
    ...
    $path = storage_path('undangan_.docx');
    $template->saveAs($path);;
    ...
    return response()->download($path, 'undangan_.docx', $headers);
    //return response()->download($file,storage_path('undangan_.docx'));
});
...
Route::get('/print/risalah/{id}', function ($id) {
    ...
    $path = storage_path('temp\risalah_.docx');
    $template->saveAs($path);;
    //return response()->download(storage_path('surat.docx'));
    return response()->download(storage_path('temp\risalah_.docx'));
});
...
Route::get('/print/peng/{id}', function ($id) {
    ...
    $path = storage_path('pengumuman_.docx');
    $template->saveAs($path);;
    //return response()->download(storage_path('surat.docx'));
    return response()->download(storage_path('pengumuman_.docx'));
});
...
Route::get('/print/sk/{id}', function ($id) {
    ...
    $path = storage_path('temp\sk_.docx');
    $template->saveAs($path);;
    //return response()->download(storage_path('surat.docx'));
    return response()->download(storage_path('temp\sk_.docx'));
});