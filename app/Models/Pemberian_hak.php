...
class Pemberian_hak extends Model
{
    ...
    protected $fillable = [
        ...
        'tanggal_st', 'no_st',  'tanggal_ris', 'no_ris', 'tgl_sk_kantah_panitia', 'no_sk_kantah_panitia',
        ...
        'no_suket_wali', 'tanggal_suket_wali', 'nama_wali_nagari', 'no_sk_kan', 'tanggal_sk_kan',
        'tanggal_surat_setoran_bphtb', 'tgl_pernyataan_tanah_yg_dipunyai', 'tanggal_tanda_batas',
        'tanggal_berkas_didaftarkan',
